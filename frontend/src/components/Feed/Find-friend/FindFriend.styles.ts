...
// NOTE: compound selectors (.FindFriendContainer h2, .tHead th, .tBody tr, .tBody td, ::before) and @media queries omitted

export const findFriendContainer: React.CSSProperties = {
  maxWidth: '900px',
  margin: '50px auto',
  padding: '25px',
...
export const profilePicture: React.CSSProperties = {
  width: '60px',
  height: '60px',
  borderRadius: '50%',
  objectFit: 'cover',
